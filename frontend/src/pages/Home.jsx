...
function Home() {
  ...
  const chatsLabel = isArabic ? 'محادثات' : 'שיחות';
  const learnedWordsLabel = isArabic ? 'كلمات تعلمناها' : 'מילים שלמדנו';
  const friendsChatTitle = isArabic ? 'شتشة مع أصدقاء' : 'שיחה עם חברות';
